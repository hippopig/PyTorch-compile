class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "i64[4, 32]", primals_4: "f32[128]", primals_7: "f32[384, 128]", primals_8: "f32[128, 128]", primals_10: "f32[128]", primals_12: "f32[256, 128]", primals_14: "f32[128, 256]", primals_16: "f32[128]", primals_19: "f32[384, 128]", primals_20: "f32[128, 128]", primals_22: "f32[128]", primals_24: "f32[256, 128]", primals_26: "f32[128, 256]", primals_28: "f32[128]", primals_30: "f32[256, 128]", iota: "i64[32]", embedding: "f32[4, 32, 128]", embedding_1: "f32[32, 128]", getitem_1: "f32[4, 32, 1]", rsqrt: "f32[4, 32, 1]", view: "f32[128, 128]", view_6: "f32[4, 4, 32, 32]", view_7: "f32[4, 4, 32, 32]", view_8: "f32[4, 4, 32, 32]", getitem_2: "f32[4, 4, 32, 32]", getitem_3: "f32[4, 4, 32]", getitem_4: "i64[]", getitem_5: "i64[]", view_9: "f32[128, 128]", mul_2: "f32[4, 32, 128]", view_11: "f32[128, 128]", addmm_1: "f32[128, 256]", view_13: "f32[128, 256]", mul_7: "f32[4, 32, 128]", view_15: "f32[128, 128]", view_21: "f32[4, 4, 32, 32]", view_22: "f32[4, 4, 32, 32]", view_23: "f32[4, 4, 32, 32]", getitem_10: "f32[4, 4, 32, 32]", getitem_11: "f32[4, 4, 32]", getitem_12: "i64[]", getitem_13: "i64[]", view_24: "f32[128, 128]", mul_9: "f32[4, 32, 128]", view_26: "f32[128, 128]", addmm_4: "f32[128, 256]", view_28: "f32[128, 256]", mul_14: "f32[4, 32, 128]", view_30: "f32[128, 128]", div: "f32[4, 32, 1]", div_1: "f32[4, 32, 1]", div_2: "f32[4, 32, 1]", div_3: "f32[4, 32, 1]", tangents_1: "f32[4, 32, 256]"):
        ...
        view_32: "f32[128, 256]" = torch.ops.aten.reshape.default(tangents_1, [128, 256]);  tangents_1 = None
        ...
        view_33: "f32[4, 32, 128]" = torch.ops.aten.reshape.default(mm_4, [4, 32, 128]);  mm_4 = None
        ...
        view_34: "f32[128, 128]" = torch.ops.aten.reshape.default(mul_21, [128, 128])
        ...
        view_35: "f32[128]" = torch.ops.aten.reshape.default(sum_5, [128]);  sum_5 = None
        view_36: "f32[4, 32, 256]" = torch.ops.aten.reshape.default(mm_5, [4, 32, 256]);  mm_5 = None
        view_27: "f32[4, 32, 256]" = torch.ops.aten.reshape.default(addmm_4, [4, 32, 256]);  addmm_4 = None
        ...
        view_37: "f32[128, 256]" = torch.ops.aten.reshape.default(mul_29, [128, 256]);  mul_29 = None
        ...
        view_38: "f32[256]" = torch.ops.aten.reshape.default(sum_6, [256]);  sum_6 = None
        view_39: "f32[4, 32, 128]" = torch.ops.aten.reshape.default(mm_7, [4, 32, 128]);  mm_7 = None
        ...
        view_40: "f32[128, 128]" = torch.ops.aten.reshape.default(clone_12, [128, 128]);  clone_12 = None
        ...
        view_41: "f32[128]" = torch.ops.aten.reshape.default(sum_11, [128]);  sum_11 = None
        view_42: "f32[32, 4, 4, 32]" = torch.ops.aten.reshape.default(mm_9, [32, 4, 4, 32]);  mm_9 = None
        ...
        view_43: "f32[16, 32, 32]" = torch.ops.aten.reshape.default(clone_13, [16, 32, 32]);  clone_13 = None
        clone_14: "f32[4, 4, 32, 32]" = torch.ops.aten.clone.default(getitem_19, memory_format = torch.contiguous_format);  getitem_19 = None
        view_44: "f32[16, 32, 32]" = torch.ops.aten.reshape.default(clone_14, [16, 32, 32]);  clone_14 = None
        clone_15: "f32[4, 4, 32, 32]" = torch.ops.aten.clone.default(getitem_18, memory_format = torch.contiguous_format);  getitem_18 = None
        view_45: "f32[16, 32, 32]" = torch.ops.aten.reshape.default(clone_15, [16, 32, 32]);  clone_15 = None
        ...
        view_46: "f32[32, 4, 128]" = torch.ops.aten.reshape.default(clone_16, [32, 4, 128]);  clone_16 = None
        ...
        view_47: "f32[32, 4, 128]" = torch.ops.aten.reshape.default(clone_17, [32, 4, 128]);  clone_17 = None
        ...
        view_48: "f32[32, 4, 128]" = torch.ops.aten.reshape.default(clone_18, [32, 4, 128]);  clone_18 = None
        ...
        select_scatter_default: "f32[3, 32, 4, 128]" = torch.ops.aten.select_scatter.default(full_default, view_46, 0, 2);  view_46 = None
        select_scatter_default_1: "f32[3, 32, 4, 128]" = torch.ops.aten.select_scatter.default(full_default, view_47, 0, 1);  view_47 = None

        # File: /home/binly/workspace/PyTorch-compile/model.py:58 in forward, code: hidden = self.transformer(hidden, mask=causal_mask, is_causal=True)
        add_22: "f32[3, 32, 4, 128]" = torch.ops.aten.add.Tensor(select_scatter_default, select_scatter_default_1);  select_scatter_default = select_scatter_default_1 = None

        # No stacktrace found for following nodes
        select_scatter_default_2: "f32[3, 32, 4, 128]" = torch.ops.aten.select_scatter.default(full_default, view_48, 0, 0);  view_48 = None

        # File: /home/binly/workspace/PyTorch-compile/model.py:58 in forward, code: hidden = self.transformer(hidden, mask=causal_mask, is_causal=True)
        add_23: "f32[3, 32, 4, 128]" = torch.ops.aten.add.Tensor(add_22, select_scatter_default_2);  add_22 = select_scatter_default_2 = None
        ...
        view_49: "f32[32, 4, 384]" = torch.ops.aten.reshape.default(clone_19, [32, 4, 384]);  clone_19 = None
        sum_12: "f32[1, 1, 384]" = torch.ops.aten.sum.dim_IntList(view_49, [0, 1], True)
        view_50: "f32[384]" = torch.ops.aten.reshape.default(sum_12, [384]);  sum_12 = None
        view_51: "f32[128, 384]" = torch.ops.aten.reshape.default(view_49, [128, 384]);  view_49 = None
        ...
        view_52: "f32[32, 4, 128]" = torch.ops.aten.reshape.default(mm_12, [32, 4, 128]);  mm_12 = None
        ...
        view_53: "f32[128, 128]" = torch.ops.aten.reshape.default(add_24, [128, 128])
        ...
        view_54: "f32[128]" = torch.ops.aten.reshape.default(sum_17, [128]);  sum_17 = None
        view_55: "f32[4, 32, 256]" = torch.ops.aten.reshape.default(mm_13, [4, 32, 256]);  mm_13 = None
        view_12: "f32[4, 32, 256]" = torch.ops.aten.reshape.default(addmm_1, [4, 32, 256]);  addmm_1 = None
        ...
        view_56: "f32[128, 256]" = torch.ops.aten.reshape.default(mul_50, [128, 256]);  mul_50 = None
        ...
        view_57: "f32[256]" = torch.ops.aten.reshape.default(sum_18, [256]);  sum_18 = None
        view_58: "f32[4, 32, 128]" = torch.ops.aten.reshape.default(mm_15, [4, 32, 128]);  mm_15 = None
        ...
        view_59: "f32[128, 128]" = torch.ops.aten.reshape.default(clone_20, [128, 128]);  clone_20 = None
        ...
        view_60: "f32[128]" = torch.ops.aten.reshape.default(sum_23, [128]);  sum_23 = None
        view_61: "f32[32, 4, 4, 32]" = torch.ops.aten.reshape.default(mm_17, [32, 4, 4, 32]);  mm_17 = None
        ...
        view_62: "f32[16, 32, 32]" = torch.ops.aten.reshape.default(clone_21, [16, 32, 32]);  clone_21 = None
        clone_22: "f32[4, 4, 32, 32]" = torch.ops.aten.clone.default(getitem_23, memory_format = torch.contiguous_format);  getitem_23 = None
        view_63: "f32[16, 32, 32]" = torch.ops.aten.reshape.default(clone_22, [16, 32, 32]);  clone_22 = None
        clone_23: "f32[4, 4, 32, 32]" = torch.ops.aten.clone.default(getitem_22, memory_format = torch.contiguous_format);  getitem_22 = None
        view_64: "f32[16, 32, 32]" = torch.ops.aten.reshape.default(clone_23, [16, 32, 32]);  clone_23 = None
        ...
        view_65: "f32[32, 4, 128]" = torch.ops.aten.reshape.default(clone_24, [32, 4, 128]);  clone_24 = None
        ...
        view_66: "f32[32, 4, 128]" = torch.ops.aten.reshape.default(clone_25, [32, 4, 128]);  clone_25 = None
        ...
        view_67: "f32[32, 4, 128]" = torch.ops.aten.reshape.default(clone_26, [32, 4, 128]);  clone_26 = None

        # No stacktrace found for following nodes
        select_scatter_default_3: "f32[3, 32, 4, 128]" = torch.ops.aten.select_scatter.default(full_default, view_65, 0, 2);  view_65 = None
        select_scatter_default_4: "f32[3, 32, 4, 128]" = torch.ops.aten.select_scatter.default(full_default, view_66, 0, 1);  view_66 = None

        # File: /home/binly/workspace/PyTorch-compile/model.py:58 in forward, code: hidden = self.transformer(hidden, mask=causal_mask, is_causal=True)
        add_28: "f32[3, 32, 4, 128]" = torch.ops.aten.add.Tensor(select_scatter_default_3, select_scatter_default_4);  select_scatter_default_3 = select_scatter_default_4 = None

        # No stacktrace found for following nodes
        select_scatter_default_5: "f32[3, 32, 4, 128]" = torch.ops.aten.select_scatter.default(full_default, view_67, 0, 0);  full_default = view_67 = None

        # File: /home/binly/workspace/PyTorch-compile/model.py:58 in forward, code: hidden = self.transformer(hidden, mask=causal_mask, is_causal=True)
        add_29: "f32[3, 32, 4, 128]" = torch.ops.aten.add.Tensor(add_28, select_scatter_default_5);  add_28 = select_scatter_default_5 = None
        ...
        view_68: "f32[32, 4, 384]" = torch.ops.aten.reshape.default(clone_27, [32, 4, 384]);  clone_27 = None
        sum_24: "f32[1, 1, 384]" = torch.ops.aten.sum.dim_IntList(view_68, [0, 1], True)
        view_69: "f32[384]" = torch.ops.aten.reshape.default(sum_24, [384]);  sum_24 = None
        view_70: "f32[128, 384]" = torch.ops.aten.reshape.default(view_68, [128, 384]);  view_68 = None
        ...
        view_71: "f32[32, 4, 128]" = torch.ops.aten.reshape.default(mm_20, [32, 4, 128]);  mm_20 = None
        ...
        view_72: "f32[32, 128]" = torch.ops.aten.reshape.default(sum_29, [32, 128]);  sum_29 = None
        ...
        index_put: "f32[128, 128]" = torch.ops.aten.index_put_.default(full_default_7, [iota], where_1, True);  full_default_7 = iota = where_1 = None
        ...
        index_put_1: "f32[256, 128]" = torch.ops.aten.index_put_.default(full_default_9, [primals_1], where_2, True);  full_default_9 = primals_1 = where_2 = None
