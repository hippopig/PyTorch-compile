class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "i64[4, 32]", primals_2: "f32[256, 128]", primals_3: "f32[128, 128]", primals_4: "f32[128]", primals_5: "f32[128]", primals_6: "f32[384]", primals_7: "f32[384, 128]", primals_8: "f32[128, 128]", primals_9: "f32[128]", primals_10: "f32[128]", primals_11: "f32[128]", primals_12: "f32[256, 128]", primals_13: "f32[256]", primals_14: "f32[128, 256]", primals_15: "f32[128]", primals_16: "f32[128]", primals_17: "f32[128]", primals_18: "f32[384]", primals_19: "f32[384, 128]", primals_20: "f32[128, 128]", primals_21: "f32[128]", primals_22: "f32[128]", primals_23: "f32[128]", primals_24: "f32[256, 128]", primals_25: "f32[256]", primals_26: "f32[128, 256]", primals_27: "f32[128]", primals_28: "f32[128]", primals_29: "f32[128]", primals_30: "f32[256, 128]"):
        ...
        view: "f32[128, 128]" = torch.ops.aten.view.default(clone, [128, 128]);  clone = None
        mm: "f32[128, 384]" = torch.ops.aten.mm.default(view, permute_1);  permute_1 = None
        view_1: "f32[32, 4, 384]" = torch.ops.aten.view.default(mm, [32, 4, 384]);  mm = None
        add_3: "f32[32, 4, 384]" = torch.ops.aten.add.Tensor(view_1, primals_6);  view_1 = primals_6 = None
        view_2: "f32[32, 4, 3, 128]" = torch.ops.aten.view.default(add_3, [32, 4, 3, 128]);  add_3 = None
        ...
        view_3: "f32[32, 16, 32]" = torch.ops.aten.view.default(select, [32, 16, 32]);  select = None
        permute_3: "f32[16, 32, 32]" = torch.ops.aten.permute.default(view_3, [1, 0, 2]);  view_3 = None
        view_4: "f32[32, 16, 32]" = torch.ops.aten.view.default(select_1, [32, 16, 32]);  select_1 = None
        permute_4: "f32[16, 32, 32]" = torch.ops.aten.permute.default(view_4, [1, 0, 2]);  view_4 = None
        view_5: "f32[32, 16, 32]" = torch.ops.aten.view.default(select_2, [32, 16, 32]);  select_2 = None
        permute_5: "f32[16, 32, 32]" = torch.ops.aten.permute.default(view_5, [1, 0, 2]);  view_5 = None
        view_6: "f32[4, 4, 32, 32]" = torch.ops.aten.view.default(permute_3, [4, 4, 32, 32]);  permute_3 = None
        view_7: "f32[4, 4, 32, 32]" = torch.ops.aten.view.default(permute_4, [4, 4, 32, 32]);  permute_4 = None
        view_8: "f32[4, 4, 32, 32]" = torch.ops.aten.view.default(permute_5, [4, 4, 32, 32]);  permute_5 = None
        ...
        view_9: "f32[128, 128]" = torch.ops.aten.view.default(clone_2, [128, 128]);  clone_2 = None
        permute_7: "f32[128, 128]" = torch.ops.aten.permute.default(primals_8, [1, 0])
        addmm: "f32[128, 128]" = torch.ops.aten.addmm.default(primals_9, view_9, permute_7);  primals_9 = permute_7 = None
        view_10: "f32[32, 4, 128]" = torch.ops.aten.view.default(addmm, [32, 4, 128]);  addmm = None
        ...
        view_11: "f32[128, 128]" = torch.ops.aten.view.default(add_6, [128, 128]);  add_6 = None
        ...
        view_12: "f32[4, 32, 256]" = torch.ops.aten.view.default(addmm_1, [4, 32, 256])
        ...
        view_13: "f32[128, 256]" = torch.ops.aten.view.default(mul_6, [128, 256]);  mul_6 = None
        permute_10: "f32[256, 128]" = torch.ops.aten.permute.default(primals_14, [1, 0])
        addmm_2: "f32[128, 128]" = torch.ops.aten.addmm.default(primals_15, view_13, permute_10);  primals_15 = permute_10 = None
        view_14: "f32[4, 32, 128]" = torch.ops.aten.view.default(addmm_2, [4, 32, 128]);  addmm_2 = None
        ...
        view_15: "f32[128, 128]" = torch.ops.aten.view.default(clone_6, [128, 128]);  clone_6 = None
        mm_1: "f32[128, 384]" = torch.ops.aten.mm.default(view_15, permute_12);  permute_12 = None
        view_16: "f32[32, 4, 384]" = torch.ops.aten.view.default(mm_1, [32, 4, 384]);  mm_1 = None
        add_11: "f32[32, 4, 384]" = torch.ops.aten.add.Tensor(view_16, primals_18);  view_16 = primals_18 = None
        view_17: "f32[32, 4, 3, 128]" = torch.ops.aten.view.default(add_11, [32, 4, 3, 128]);  add_11 = None
        ...
        view_18: "f32[32, 16, 32]" = torch.ops.aten.view.default(select_3, [32, 16, 32]);  select_3 = None
        permute_14: "f32[16, 32, 32]" = torch.ops.aten.permute.default(view_18, [1, 0, 2]);  view_18 = None
        view_19: "f32[32, 16, 32]" = torch.ops.aten.view.default(select_4, [32, 16, 32]);  select_4 = None
        permute_15: "f32[16, 32, 32]" = torch.ops.aten.permute.default(view_19, [1, 0, 2]);  view_19 = None
        view_20: "f32[32, 16, 32]" = torch.ops.aten.view.default(select_5, [32, 16, 32]);  select_5 = None
        permute_16: "f32[16, 32, 32]" = torch.ops.aten.permute.default(view_20, [1, 0, 2]);  view_20 = None
        view_21: "f32[4, 4, 32, 32]" = torch.ops.aten.view.default(permute_14, [4, 4, 32, 32]);  permute_14 = None
        view_22: "f32[4, 4, 32, 32]" = torch.ops.aten.view.default(permute_15, [4, 4, 32, 32]);  permute_15 = None
        view_23: "f32[4, 4, 32, 32]" = torch.ops.aten.view.default(permute_16, [4, 4, 32, 32]);  permute_16 = None
        ...
        view_24: "f32[128, 128]" = torch.ops.aten.view.default(clone_8, [128, 128]);  clone_8 = None
        permute_18: "f32[128, 128]" = torch.ops.aten.permute.default(primals_20, [1, 0])
        addmm_3: "f32[128, 128]" = torch.ops.aten.addmm.default(primals_21, view_24, permute_18);  primals_21 = permute_18 = None
        view_25: "f32[32, 4, 128]" = torch.ops.aten.view.default(addmm_3, [32, 4, 128]);  addmm_3 = None
        ...
        view_26: "f32[128, 128]" = torch.ops.aten.view.default(add_14, [128, 128]);  add_14 = None
        ...
        view_27: "f32[4, 32, 256]" = torch.ops.aten.view.default(addmm_4, [4, 32, 256])
        ...
        view_28: "f32[128, 256]" = torch.ops.aten.view.default(mul_13, [128, 256]);  mul_13 = None
        permute_21: "f32[256, 128]" = torch.ops.aten.permute.default(primals_26, [1, 0])
        addmm_5: "f32[128, 128]" = torch.ops.aten.addmm.default(primals_27, view_28, permute_21);  primals_27 = permute_21 = None
        view_29: "f32[4, 32, 128]" = torch.ops.aten.view.default(addmm_5, [4, 32, 128]);  addmm_5 = None
        ...
        view_30: "f32[128, 128]" = torch.ops.aten.view.default(add_18, [128, 128]);  add_18 = None
        mm_2: "f32[128, 256]" = torch.ops.aten.mm.default(view_30, permute_22);  permute_22 = None
        view_31: "f32[4, 32, 256]" = torch.ops.aten.view.default(mm_2, [4, 32, 256]);  mm_2 = None
