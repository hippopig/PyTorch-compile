...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/if/cif4ejmgvn6fycj4rosp7ozibaemw4kqjhtijaqlo33h4rnpnkfk.py
...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/7u/c7ulsm2mfseafsk2wsnkfycy5net6nfsh6bdptszno6crevkgiku.py
...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/3a/c3aarvhpm7xkpydks2km5m4kfdrglybe33b4eiqrcxl6atlnlrux.py
...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/wf/cwf7tou5bargvct6gwsaesbpnlalqsgbi432uohngqzmgdc2sfvu.py
...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/gg/cgg2jqsus3buktc7bfoxpodxlxf2kfjkmas3zqnkidzclbwow3fe.py
...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/6w/c6wf6eetypylmnokinqsvw3dsoohwg4mfvihak2j375yhtqlz23o.py
# Topologically Sorted Source Nodes: [multi_head_attention_forward], Original ATen: [aten._unsafe_view, aten.add, aten.view, aten.unsqueeze, aten.transpose, aten.squeeze, aten.clone, aten.select]
# Source node to ATen node mapping:
...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/z5/cz5ubdowmbtuvqyqfil526tm7jjuy5kykwymhs7t3jid55fywr4k.py
# Topologically Sorted Source Nodes: [multi_head_attention_forward], Original ATen: [aten._unsafe_view, aten.add, aten.view, aten.unsqueeze, aten.transpose, aten.squeeze, aten.clone, aten.select]
# Source node to ATen node mapping:
...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/zs/czsi4xq6iuk6kwvwfftbw3dp46btwc4cod72q3e56xx3wusdypnz.py
...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/ft/cft2ygjmx5c2k6y3fya355yzvtflepag6p2g7y4frio4s2sicep3.py
...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/on/consbhu3y5lbksgptbjkqj6txnrgomtzcla5r6bt4jhu2j5qeidv.py
...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/pw/cpwwivmd4ugvi4lr3oi72crk6eep2pg7m25boh2rymprl5se3zei.py
...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/ld/cld2e662zekvp7rah5sfqnkfo2wxmlirunh3bayugqbfvynf6wtp.py
...
# kernel path: /tmp/torchinductor_binly/tmpsefmm0hg/5b/c5bo7heakn7ahz3ub4sva6enb5csab7ohn74c75ag5bqpmpy3tr2.py
